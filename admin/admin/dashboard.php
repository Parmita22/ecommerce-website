...
<head>
    ...
    <title>shopproject - adminpanel - dashboard page</title>
</head>
<body>
            ...
            <section class="dashboard">
                ...
                <div class="box-container">
                    ...
                    <div class="box">
                        ...
                        <a href="account.php" class="btn">view admins</a>
                    </div>
                    <div class="box">
                        <?php 
                    ...
                    <div class="box">
                        ...
                        ?> 
                        <h3><?= $num_of_orders; ?></h3>
                        <p>total number of order placed</p>
                    ...
                    <div class="box">
                            ...
                            <p>total number of confirm order placed</p>
                        ...
                        <div class="box">
                            ...
                            <p>total number of canceled order placed</p>
