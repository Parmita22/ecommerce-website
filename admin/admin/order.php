<?php 
    ...
    if(isset($_POST['update_order'])){
        ...
        $update_payment = filter_var($order_id, FILTER_SANITIZE_STRING);
...
<head>
    ...
    <title>shopproject - adminpanel - order placed page</title>
</head>
<body>
        ...
        <section>
            ...
            <section class="order-container">
                ...
                <div class="box-container">
                    ...
                    ?>
                    <div class="box">
                        <div class="status" style="color:<?php if($fetch_orders['status']=='in progress'){echo 'green';}else{
                            echo "red";
